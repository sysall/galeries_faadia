      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-4xl font-bold text-gold-400 mb-2">250+</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-4xl font-bold text-gold-400 mb-2">45</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gold-400 mb-2">And your happiness.</h3>
